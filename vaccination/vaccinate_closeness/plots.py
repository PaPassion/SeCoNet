...
def general_sir(susceptible, infected, recovered, vaccinated):
    ...
    plt.plot(ticks, vaccinated, label='vaccinated', color='#fbcd31')
...
def gender_sir(female_susceptible, female_infected, female_recovered, female_vaccinated,
    ...
    ax[0][0].plot(ticks, female_vaccinated, label='vaccinated', color='#fbcd31')
    ...
    ax[0][1].plot(ticks, male_vaccinated, label='vaccinated', color='#fbcd31')
