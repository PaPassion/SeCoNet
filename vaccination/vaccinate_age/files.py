...
def record_sir(path, susceptible, infected, recovered, vaccinated, female_susceptible, female_infected, female_recovered,
               female_vaccinated, male_susceptible, male_infected, male_recovered, male_vaccinated):
    dict = {'susceptible': susceptible, 'infected': infected, 'recovered': recovered, 'vaccinated': vaccinated,
            'female_susceptible': female_susceptible, 'female_infected': female_infected,
            'female_recovered':female_recovered, 'female_vaccinated': female_vaccinated,
